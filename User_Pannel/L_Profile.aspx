<%@ Page Title="" Language="C#" MasterPageFile="~/User_Pannel/User.master" AutoEventWireup="true" CodeFile="L_Profile.aspx.cs" Inherits="User_Pannel_L_Profile" %>
					...
					<div>			
						<div class="match-profile">
                            ...
                            <%  
                                ...
                                var genders = Request.Cookies["Gender"].Value;
                                List<Tb_Data> lst = db.Tb_Data.Where(z => z.Gender == genders).ToList();
