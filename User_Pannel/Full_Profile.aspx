<%@ Page Title="" Language="C#" MasterPageFile="~/User_Pannel/User.master" AutoEventWireup="true" CodeFile="Full_Profile.aspx.cs" Inherits="User_Pannel_Full_Profile" %>
		...
		<div class="col-md-9 profiles-list-agileits">
			<div class="single_w3_profile">
				...
				<div class="w3layouts_details">
					...
					<a href="Profile.aspx?id=<%=list.Id %>" data-toggle="modal" data-target="#myModal"></a>
